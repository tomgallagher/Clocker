export const DefaultSettingsLayouts = {
    ...
    md: [
        ...
        { i: 'mobileEmulation', w: 2, h: 2, x: 8, y: 2, isBounded: true },
    ],
    // 6 columns
    sm: [
        ...
        { i: 'mobileEmulation', w: 3, h: 2, x: 3, y: 6, isBounded: true },
    ],
    // 4 columns
    xs: [
        ...
        { i: 'mobileEmulation', w: 2, h: 2, x: 2, y: 7, isBounded: true },
    ],
    // 2 columns
    xxs: [
        ...
        { i: 'mobileEmulation', w: 2, h: 2, x: 2, y: 6, isBounded: true },
    ],
};
